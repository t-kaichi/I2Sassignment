...
# train
flags.DEFINE_string("dataset", "CMU_MoCap", "TotalCapture or CMU_MoCap")
flags.DEFINE_string("attachment", "lower_body", "full_body or lower_body or upper_body or action_recognition")
flags.DEFINE_boolean("acc_norm", False, "acc_norm")
...
# test
flags.DEFINE_string("load_model", "./logs/", "path to load model")
